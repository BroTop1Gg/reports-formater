...
metadata:
  ...
  CURRENT_YEAR: "2026"
page_numbering: true
header_text: "Title + Numbering Test"
---
...
ALIGNMENT: LEFT - This paragraph should be aligned to the left edge.

ALIGNMENT: CENTER - This paragraph should be centered.

ALIGNMENT: RIGHT - This paragraph should be aligned to the right edge.

ALIGNMENT: JUSTIFY - This paragraph should be justified (both edges aligned). Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore.
...
Цей додаток демонструє роботу колонтитулів на багатосторінкових додатках. Наступна таблиця має багато рядків, щоб примусово перенести частину контенту на наступну сторінку. На другій сторінці цього додатка вгорі має з'явитися колонтитул «Продовження додатка Б».

Таблиця Б.1 — Велика таблиця для тесту перенесення сторінки
| Параметр | Значення |
|----------|----------|
| Рядок 1 | Значення 1 |
| Рядок 2 | Значення 2 |
...
| Рядок 8 | Значення 8 |
| Рядок 9 | Значення 9 |
| Рядок 10 | Значення 10 |
| Рядок 11 | Значення 11 |
| Рядок 12 | Значення 12 |
| Рядок 13 | Значення 13 |
| Рядок 14 | Значення 14 |
| Рядок 15 | Значення 15 |
| Рядок 16 | Значення 16 |
| Рядок 17 | Значення 17 |
| Рядок 18 | Значення 18 |
| Рядок 19 | Значення 19 |
| Рядок 20 | Значення 20 |
| Рядок 21 | Значення 21 |
| Рядок 22 | Значення 22 |
| Рядок 23 | Значення 23 |
| Рядок 24 | Значення 24 |
| Рядок 25 | Значення 25 |
| Рядок 26 | Значення 26 |
| Рядок 27 | Значення 27 |
| Рядок 28 | Значення 28 |
| Рядок 29 | Значення 29 |
| Рядок 30 | Значення 30 |
